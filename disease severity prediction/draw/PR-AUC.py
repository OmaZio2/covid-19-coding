...
OneDCNN_True = np.load(
    r'D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\1D-CNN\1D-CNN(Y_true)5.npy')
OneDCNN_Pro = np.load(
    r'D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\1D-CNN\1D-CNN(Y_predict_probability)5.npy')

LSTM_True = np.load(
    r'D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\LSTM\LSTM(Y_true)7.npy')
LSTM_Pro = np.load(
    r'D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\LSTM\LSTM(Y_predict_probability)7.npy')
...
TwoDCNN_True = np.load(
    r"D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\2D-CNN\2D-CNN(Y_true)5.npy")
TwoDCNN_Pro = np.load(
    r"D:\Code\covid-19\COVID-19-Prediction-master\COVID-19 Prediction Code\disease severity prediction\result\numpy data\2D-CNN\2D-CNN(Y_predict_probability)5.npy")
