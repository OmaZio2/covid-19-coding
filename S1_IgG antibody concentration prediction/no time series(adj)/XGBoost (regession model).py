...
for Method in range(1, 4):
    ...
    if flag:
        sys.stdout = open(f"../result/model result(adjust)/XGBoost/{method}_XGBoost.txt", "w")
        flag = False
    else:
        sys.stdout = open(f"../result/model result(adjust)/XGBoost/{method}_XGBoost.txt", "a")
    ...
    plt.savefig(f"../result/model result(adjust)/XGBoost/{method}_XGBoost.png", dpi=600)
    # plt.show()
